	...
	return <IpfsContext.Provider value={{
		...
		notConnectedMessage: <Stack spacing={2}>
			...
			<Alert severity={'info'}>
				...
				<code>
					<p>
						ipfs config --json API.HTTPHeaders.Access-Control-Allow-Origin '["https://ipfs-toolbox.on.fleek.co",
						"http://ipfs-toolbox.on.fleek.co.localhost:8080", "http://localhost:3000", "http://127.0.0.1:5001",
						"https://webui.ipfs.io"]'
					</p>
					<p>ipfs config --json API.HTTPHeaders.Access-Control-Allow-Methods '["PUT", "POST"]'</p>
				</code>
			</Alert>
		</Stack>,
	}}>
